...
\begin{itemize}[leftmargin=*,itemsep=3pt]
    \item \textbf{12 accepted papers} at top ML conferences (ICML, ICLR, NeurIPS, COLM, CVPR, ACL), including \textbf{4 oral presentations}; 3 additional manuscripts under review.
