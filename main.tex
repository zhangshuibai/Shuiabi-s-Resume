...
\begin{itemize}[leftmargin=*,itemsep=3pt]
    \item \textbf{12 accepted papers} at top ML conferences (ICML, ICLR, NeurIPS, COLM, CVPR, ACL), including \textbf{4 oral presentations}; 4 additional manuscripts under review.
    ...
    \item Reviewer for \textbf{ICLR}, \textbf{ICML}, \textbf{NeurIPS}, \textbf{COLM}, \textbf{ACL}, and \textbf{CVPR}.
\end{itemize}
}
...
\resumeProject
  ...
  {Open Source Project}
  {Jul 2025 -- Sep 2025}
  {{[\href{https://github.com/pengzhangzhi/Open-dLLM}{\textcolor{darkblue}{GitHub (\faStar{} 649)}}] \; [\href{https://oval-shell-31c.notion.site/Open-dLLM-Open-Diffusion-Large-Language-Model-25e03bf6136480b7a4ebe3d53be9f68a}{\textcolor{darkblue}{Project Page}}]}}
\resumeItemListStart
  ...
  \item Project has received strong community adoption with \textbf{649 GitHub stars} by Aug 2026.
\resumeItemListEnd
\resumeSubHeadingListEnd
...
\hfill \textit{Under Review --- ICLR 2027}

\item \href{https://arxiv.org/abs/2608.12149}{
Zunhai Su, Bohan Sun, Xialie Zhuang, \textbf{Shuibai Zhang}, He Xiao, Jing Xiong, Hengyuan Zhang, Zhongzhu Zhou, Tiantian Zhang, Ngai Wong, Chuan-Wei Kuo,
